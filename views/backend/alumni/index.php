...
<label class="text-sm font-medium">Pendidikan lanjutan<input id="aEducation" name="further_education" maxlength="160" class="block w-full mt-1 px-3 py-2 border-slate-300 rounded-lg"></label>
...
function editAlumni(i){aId.value=i.id;aName.value=i.name||'';aYear.value=i.graduation_year||'';aClass.value=i.final_class||'';aEducation.value=i.further_education||'';aOccupation.value=i.occupation||'';aInstitution.value=i.institution||'';aCity.value=i.city||'';aContact.value='';aStory.value=i.story||'';aAchievement.value=i.achievement||'';aStatus.value=i.status;aOrder.value=i.sort_order||0;aFeatured.checked=i.is_featured==1;aPublishPhoto.checked=i.publish_photo==1;aPublishJob.checked=i.publish_occupation==1;aPublishCity.checked=i.publish_city==1;aTitle.textContent='Edit Alumni';aRemoveLabel.classList.toggle('hidden',!i.photo);alumniModal.classList.replace('hidden','flex')}
