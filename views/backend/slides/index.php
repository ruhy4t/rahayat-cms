                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button onclick='editSlide(<?= json_encode(Security::normalizeTextData($slide), JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_HEX_TAG) ?>)'
        ...
        <form id="slideForm" enctype="multipart/form-data">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-1">Format: JPG, PNG, GIF, WebP. Maks: 2 MB. Ukuran optimal: 1920x1080 piksel.</p>
