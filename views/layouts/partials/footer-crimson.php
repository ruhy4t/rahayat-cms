    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12">
            ...
            <div class="md:col-span-5 text-center md:text-left">
                ...
                <!-- Social Media Links -->
                <div class="flex items-center space-x-3 mt-8 max-w-xs mx-auto md:mx-0">
                    <?php if (!empty($settings['social_facebook'])): ?>
                        <a href="<?= e($settings['social_facebook']) ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl border border-slate-700/50 bg-slate-800/50 flex items-center justify-center text-slate-400 hover:bg-primary-600 hover:text-white hover:border-primary-500 transition-all shadow-sm">
                    ...
                    <?php if (!empty($settings['social_instagram'])): ?>
                        <a href="<?= e($settings['social_instagram']) ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl border border-slate-700/50 bg-slate-800/50 flex items-center justify-center text-slate-400 hover:bg-pink-600 hover:text-white hover:border-pink-500 transition-all shadow-sm">
                    ...
                    <?php if (!empty($settings['social_twitter'])): ?>
                        <a href="<?= e($settings['social_twitter']) ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl border border-slate-700/50 bg-slate-800/50 flex items-center justify-center text-slate-400 hover:bg-slate-700 hover:text-white hover:border-slate-600 transition-all shadow-sm">
                    ...
                    <?php if (!empty($settings['social_youtube'])): ?>
                        <a href="<?= e($settings['social_youtube']) ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl border border-slate-700/50 bg-slate-800/50 flex items-center justify-center text-slate-400 hover:bg-red-600 hover:text-white hover:border-red-500 transition-all shadow-sm">
            ...
            <div class="md:col-span-7">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="p-6 bg-slate-800/50 rounded-2xl border border-slate-700 backdrop-blur-sm text-center">
                    </div>
                </div>
            </div>
        </div>
